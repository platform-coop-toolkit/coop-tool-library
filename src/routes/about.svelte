...
<div class="grid-container--half-width">
	...
	<h2>Who is the Tool Library for?</h2>
	<p>The Tool Library was built to be centred around cooperatives, prospective cooperatives, and those who assist in the development of cooperatives. However, anyone in the cooperative ecosystem can use this library.</p>

	<h2>Who runs the Tool Library?</h2>
